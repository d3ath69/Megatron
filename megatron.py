...
\033[91m
    ...
    ██      ██ ███████  ██████  ██   ██    ██    ██   ██  ██████  ██   ████
\033[0m
    \033[90mAI Penetration Testing Assistant  |  Model: Qwen2.5-7B-Instruct  |  Ubuntu\033[0m
    \033[90m─────────────────────────────────────────────────────────────────────\033[0m
""")
...
def main_menu():
    while True:
        ...
        if choice == "1":
            ...
            print("\n\033[91m[*] Shutting down Megatron. Stay legal.\033[0m\n")
            sys.exit(0)
